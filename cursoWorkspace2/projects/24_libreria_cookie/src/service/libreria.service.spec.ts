...
describe('LibreriaService', () => {
  ...
  it('debe autenticar correctamente al usuario', () => {
    ...
    service.autenticarUsuario('test1', 'test1').subscribe(cliente => {
  ...
  it('debe obtener el catálogo de libros', () => {
    ...
    service.catalogoLibros().subscribe(libros => {
...
/*pruebas realizadas contra backend real
...
describe('LibreriaService', () => {
  ...
  it('debe ser usuario válido', (done) => {
    service.autenticarUsuario("test1","test1").subscribe({
      next: r=>{
  ...
  it('no es cliente válido', (done) => {
    service.autenticarUsuario("test44","test44").subscribe({
      next: r=>{
        expect(r).toBeNull();
        done();
    },
  ...
  it('total de libros', (done) => {
    service.catalogoLibros().subscribe({
    next: (r) => {
